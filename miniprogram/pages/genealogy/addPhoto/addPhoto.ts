import {generateUUID,getCurrentPath,shareTo,checkCanUpload} from '../../../utils'
import {getUserInfoOrFalse} from '../../../user'
import {requestNotice, sendNotifyVerifyMsg} from '../../../msg'
...
Page({
  ...
  onShareAppMessage: function () {
    ...
    return shareTo('来给' + this.data.cat.name + '添加照片 - HENU 猫协', path);
  },
