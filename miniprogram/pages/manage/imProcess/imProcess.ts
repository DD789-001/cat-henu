// miniprogram/pages/imProcess/imProcess.ts
import {generateUUID,isManager} from '../../../utils'
...
Page({
  ...
  compress: function() {
    ...
    ctx.fillText('HENU 猫协@' + (photo.photographer || userInfo.nickName), 30, draw_height - (draw_height * 0.03));
