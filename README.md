...
<img src="./readme/qrcode1.png" width = "200" height = "200" alt="HENU 猫协菊花码" />
...
- [ ] （:warning:2021/5/28更新，保证Release稳定）进入[Releases页面](https://github.com/DD789-001/cat-henu/releases)，下载最新版本的的Source code(zip)，解压
...
期望：关于页出现HENU 猫协的友情链接、科普的二级页面出现文字信息，则说明创建成功。
...
本项目遵循MPL-2.0开源协议。在此基础上，如果你发布了一份新的猫谱，我们希望你能保留HENU 猫协的友情链接。待你的线上版本稳定使用一段时间后，请留言告诉我们将你的友链加到HENU 猫协小程序中。
